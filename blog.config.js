...
const BLOG = {
  ...
  MUSIC_PLAYER_METING_SERVER: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'xiami', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '孤风', // 站点标题 ，被notion中的页面标题覆盖
