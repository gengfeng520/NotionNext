...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '孤风', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '愿与君携手🤝阔步上青云', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://guifeng.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'gufeng416@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIXIN: process.env.NEXT_PUBLIC_CONTACT_WEIXIN || 'litianbug🔞', // 你的微信账号
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/gufeng520131', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/gengfeng520', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-preiview-six.vercel.app/', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
