...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '与君同携手∞阔步上青云🤝', // 作者简介
  ...
  MUSIC_PLAYER_METING_SERVER: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'baidu', // 音乐平台，[netease, tencent, kugou, xiami, baidu,]
